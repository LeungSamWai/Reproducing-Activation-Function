...
class Camera(Dataset):
    def __init__(self, downsample_factor=1):
        ...
        # self.img = Image.fromarray(rgb2gray(skimage.data.astronaut()))
        self.img_channels = 1
...
class Cat(Dataset):
    def __init__(self, downsample_factor=1):
        ...
        # self.img = Image.fromarray(skimage.data.camera())
        from skimage.color import rgb2gray
        self.img = Image.fromarray(rgb2gray(skimage.data.chelsea()))
        self.img_channels = 1
...
class coin(Dataset):
    def __init__(self, downsample_factor=1):
        ...
        # self.img = Image.fromarray(skimage.data.camera())
        from skimage.color import rgb2gray
        self.img = Image.fromarray(rgb2gray(skimage.data.coins()))
        self.img_channels = 1
